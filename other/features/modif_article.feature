Fonctionnalité: Modifier son annonce
    
Scénario: Le client veut modifier son annonce
    Étant donné que le client veut modifier une annonce qu'il a postée
    Et qu'il est connecté (voir "identification.feature")
